...
namespace ScreenProducerAPI.IntegrationTests.Tests.Services
{
    ...
    public class StockStatisticsServiceTests
    {
        ...
        public async Task SetUp()
        {
            ...
            _equipmentService = _scope.ServiceProvider.GetRequiredService<EquipmentService>();
            ...
            _service = new StockStatisticsService(_context, _targetConfig, _stockConfig, _equipmentService);
